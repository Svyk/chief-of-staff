...
export async function buildHelpSummary() {
  ...
  const providerLabel = { anthropic: "Anthropic", openai: "OpenAI", gemini: "Google Gemini", mistral: "Mistral", groq: "Groq", grok: "Grok (xAI)", kimi: "Kimi (Moonshot)" }[provider] || provider;
