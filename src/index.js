  ...
  const starterSkills = [
    ...
    },
    {
      ...
      steps: [
        ...
        "Constraints: Must Do — quote every guardrail verbatim in the report; give a per-item justification; include the token estimate. Must Not Do — never modify the live skill (draft copy only); never classify data-safety rules (approval gating, never-fabricate, reversibility, UID validation) as stale regardless of evidence — they are domain constraints by definition. Escalate — if more than half of a skill classifies as stale, stop and ask whether the skill is still needed at all before recommending line-level removals.",
